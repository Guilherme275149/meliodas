...
const botfeio = 'Você Parece Com a Dsgc Eu Não Te Falo Nada😡'
const cadebot = 'Me chamou onii-chan 👉👈?'
const botfdp = 'Puta Er Sua Mãe Seu Arrombado Vsfd Filho De Cruz Credo Aaaa Tmnc'
const botgostoso = 'Arigato go sai masu 😳👉👈'
const botfofo = 'Arigato go sai masu 😳👉👈'
const botbaianor = 'Convidei sua mãe pra minha rede seu fela da puta se tá no circo seu arrombado'
const botcorno = 'Corno er seu pai aquele crakudo, tranzei com sua, mãe ontem foi mó bom'
const botputa = 'Já Falei Que Er Sua Mãe'
const botgay = 'Seu Pai Aquele Firmose😡'
const botviado = 'Seu Pai Kkk😡'
const numbotfeio = 'Blz Mais C aguenta 3cm 😳'
// KEYS
